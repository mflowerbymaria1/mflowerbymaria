...
export default function ProductDetailPage({ params }) {
    ...
    const getIntroDescription = () => {
        ...
        if (nameLower.includes('salchicha') || nameLower.includes('perrito')) return 'El detalle más tierno y aesthetic para llenar tu escritorio de estilo y personalidad. Diseñado en un delicado tono rosa pastel, es el compañero ideal para tu rincón de estudio o trabajo.';
        if (nameLower.includes('resaltador') || nameLower.includes('aurora')) return 'Un set adorable y súper práctico para llenar tus apuntes y lecturas de colores suaves y prolijos. Vienen en tamaño mini para llevarlos a todos lados sin ocupar espacio.';
                        ...
                        <div className="product-info-container">
                            ...
                            <div className="actions-box">
                                ...
                                <div className="production-delay-info">
                                    ...
                                    {isFichero || product.name.toLowerCase().includes('pack') ? (
